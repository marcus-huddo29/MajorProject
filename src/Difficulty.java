...
public enum Difficulty {
    ...
    public int getEnemiesAttackingCount() {
        return enemiesAttackingCount;
    }

    public boolean useCombinedInitiative() {
        return combinedInitiative;
    }

    public boolean useLongerCooldown() {
        return longerCooldown;
    }
}
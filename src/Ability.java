...
public class Ability {
    ...
    private final String targetType; // NEW: To store "Single" or "All"
    private int currentCooldown;
    private double statusChance;

    public Ability(String abilityName, int minDamage, int maxDamage, String statusInflicted, int cooldown, String targetType) {
        this.abilityName = abilityName;
        this.minDamage = minDamage;
        this.maxDamage = maxDamage;
        this.statusInflicted = statusInflicted;
        this.baseCooldown = cooldown;
        this.targetType = targetType; // NEW
    ...
    public String getTargetType() { return targetType; } // NEW
